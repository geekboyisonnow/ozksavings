...
class DepositsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create deposit" do
    assert_difference('Deposit.count') do
      post deposits_url, params: { deposit: { goal_id: @deposit.goal_id, which_goal: @deposit.which_goal } }
    end
  ...
  test "should update deposit" do
    patch deposit_url(@deposit), params: { deposit: { goal_id: @deposit.goal_id, which_goal: @deposit.which_goal } }
